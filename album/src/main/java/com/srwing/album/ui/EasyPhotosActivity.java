...
import com.srwing.album.EasyPhotos;
import com.srwing.album.R;
import com.srwing.album.constant.Code;
import com.srwing.album.constant.Key;
import com.srwing.album.constant.Type;
import com.srwing.album.models.ad.AdListener;
import com.srwing.album.models.album.AlbumModel;
import com.srwing.album.models.album.entity.Photo;
import com.srwing.album.result.Result;
import com.srwing.album.setting.Setting;
import com.srwing.album.ui.adapter.AlbumItemsAdapter;
import com.srwing.album.ui.adapter.PhotosAdapter;
import com.srwing.album.ui.dialog.LoadingDialog;
import com.srwing.album.ui.widget.PressedTextView;
import com.srwing.album.utils.Color.ColorUtils;
import com.srwing.album.utils.String.StringUtils;
import com.srwing.album.utils.bitmap.BitmapUtils;
import com.srwing.album.utils.media.DurationUtils;
import com.srwing.album.utils.media.MediaScannerConnectionUtils;
import com.srwing.album.utils.permission.PermissionUtil;
import com.srwing.album.utils.settings.SettingsUtils;
import com.srwing.album.utils.system.SystemUtils;
import com.srwing.album.utils.uri.UriUtils;
...
public class EasyPhotosActivity extends AppCompatActivity implements AlbumItemsAdapter.OnClickListener, PhotosAdapter.OnClickListener, AdListener, View.OnClickListener {
    ...
    public static boolean doubleClick(int milSeconds) {
        long now = System.currentTimeMillis();
        if (now - startTime < milSeconds) {
            return true;
        }
        startTime = now;
        return false;
